...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        agent_root = module_root.parent
        workspace_root = module_root.parents[1]
        config_path = Path(os.getenv("SCHOLAR_SEARCH_CONFIG", agent_root / "config" / "database.env")).expanduser().resolve()
