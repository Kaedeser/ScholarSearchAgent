...
from offline_evaluation.evaluation import Evaluator
from result_composition.composer import ResultComposer
from scholar_common.io import default_processed_dir, write_json, write_text
...
def build_parser() -> argparse.ArgumentParser:
    ...
    serve = subparsers.add_parser("serve", help="Start a small browser demo without extra dependencies")
